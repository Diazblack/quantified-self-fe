...
function showCalendar(json_response){
  ...
  calendar_data_array.forEach(calendar_date => {
    ...
    var breakfast_data = calendar_date["meals"][0]["foods"][0]["name"]
    var snack_data = calendar_date["meals"][1]["foods"][0]["name"]
    var lunch_data = calendar_date["meals"][2]["foods"][0]["name"]
    var dinner_data = calendar_date["meals"][3]["foods"][0]["name"]
